...
enum KeyboardKeys
{
    ...
    VK_KEY_8, VK_KEY_9, VK_KP_0,  VK_KP_1,  VK_KP_2,  VK_KP_3,  VK_KP_4,  VK_KP_5,  VK_KP_6,  VK_KP_7,
    VK_KP_8,  VK_KP_9,  VK_KEY_A, VK_KEY_B, VK_KEY_C, VK_KEY_D, VK_KEY_E, VK_KEY_F, VK_KEY_G, VK_KEY_H,
    ...
    VK_OEM_1, VK_OEM_2, VK_OEM_3, VK_OEM_4, VK_OEM_5, VK_OEM_6, VK_OEM_7,  VK_OEM_8, VK_OEM_9,
    VK_OEM_MINUS, VK_OEM_PLUS, VK_DOWN, VK_LEFT, VK_RIGHT, VK_UP, VK_CAPITAL,
    _VK_KEY_MAX
};
